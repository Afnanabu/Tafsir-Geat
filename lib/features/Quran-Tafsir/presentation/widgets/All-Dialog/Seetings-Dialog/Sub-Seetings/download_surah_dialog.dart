...
class DownloadAyatDialog extends StatefulWidget {
  ...
  const DownloadAyatDialog({required this.title}) ;

  @override
  _DownloadAyatDialogState createState() => _DownloadAyatDialogState(this.title);
}
...
class _DownloadAyatDialogState extends State<DownloadAyatDialog> {
  ...
  _DownloadAyatDialogState(this.title);
