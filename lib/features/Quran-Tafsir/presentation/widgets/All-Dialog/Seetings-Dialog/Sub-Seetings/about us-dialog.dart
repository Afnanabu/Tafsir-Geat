            ...
            child: Column(
              children: [
               Image.asset('assest/Page-Image/godImage.jpg'),
                Text('تمتلك وقفية الأمير غازي للفِكر القرآنيّ موقع التفاسير العظيمة GreatTafsirs.com وهو وقف ذُرّيّ غير ربحي ومقرّه الأردن تم تأسيسه في عام ١٤٣٣هـ /٢٠١٢ م. وقد أسّس مشاريع أخرى مثل موقع الفِكر القرآنيّ'
